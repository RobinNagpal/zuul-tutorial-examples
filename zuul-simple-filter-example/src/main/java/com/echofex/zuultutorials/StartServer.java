 ...
 */
package com.echofex.zuultutorials;
...
public class StartServer extends GuiceServletContextListener {
	...
	/**
	 * Overridden solely so we can tell how much time is being spent in overall
	 * initialization. Without overriding we can't tell how much time was spent
	 * in BaseServer doing its own initialization.
	 *
	 * @param sce
	 */
	@Override
